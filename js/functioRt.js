function RealizarRt() {
    ...
    const containerOff = document.getElementById("materialDisponivelTable");
    ...
    if (!document.querySelector(".container-rt")) {

        const div = document.createElement("div");
        div.classList.add("container-rt")
        ...
        div.innerHTML = `
            ...
            <table id="materialRt">
                ...
                <tbody >
                    <tr>
                        ...
                        <td>P1</td>
                        <td>34U</td>
                        <td><input type="checkbox" name="selecionarCheckbox" class="checkboxRt"></td>
                    </tr>
                    <tr>
                        <td>456782</td>
                        <td>P2</td>
            ...
            <button type="submit" id="buttonConfirmarRt" onclick="PesquisarIdRt()">Confirmar Retorno</button>
        `

        container.appendChild(div);
        // Fim da criação do conteúdo da seção de retornos


        // Função para voltar aos materiais disponíveis

        const materialDisponivel = document.getElementById("materialDisponivel")
        materialDisponivel.addEventListener("click", () => {
        ...
        function atualizarMenu() {
            const checkboxes = document.querySelectorAll(".checkboxRt");
            const selectedCb = Array.from(checkboxes).some(cb => cb.checked)

            if (selectedCb) {
                document.getElementById("buttonConfirmarRt").style.display = "block";
            } else {
                document.getElementById("buttonConfirmarRt").style.display = "none";
            }
        }
